...
<?php
	...
	if(!(isset($_POST["nom"]) and trim($_POST["nom"])!="" and isset($_POST["prenom"]) and trim($_POST["prenom"])!="" and isset($_POST["qualite"]) and trim($_POST["qualite"])!="" and isset($_POST["composante2"]) and trim($_POST["composante2"])!="" and isset($_POST["laboratoire2"]) and trim($_POST["laboratoire2"])!="" and isset($_POST["tel"]) and trim($_POST["tel"])!="" and isset($_POST["mail"]) and trim($_POST["mail"])!="" ))
		echo "";
	else {
		...
		if(!is_dir($rep))
			{
				mkdir("$rep");
				$sql = 'INSERT INTO demandeur (nom, prenom ,qualite ,composante , laboratoire ,tel , mail) VALUES (:nom, :prenom ,:qualite ,:composante ,:laboratoire ,:tel ,:mail)';
				try
					{
						$req = $bd->prepare($sql);
						...
						$req->bindValue(':composante'	,htmlspecialchars($_POST['composante2']));
						$req->bindValue(':laboratoire'	,htmlspecialchars($_POST['laboratoire2']));
					...
					<legend><span class="number">1</span>Coordinateur Paris 13</legend>
						<div class="masquable">
							...
							<div class="masquable-contenu">
								...
								<p><label> Prénom : </label> <input type="text" name="Composante" id="Composante"/></p>
									
								<p><label> Nom : </label><input type="text" name="Laboratoire" id="Laboratoire"/></p>
									
								<p><label> Qualité : </label><input type="text" name="Laboratoire" id="Laboratoire"/></p>
				...
				<fieldset>
					...
					<div class="masquable ferme">
						...
						<div class="masquable-contenu">
							...
							<p><label> Téléphone* : </label>	<input type="text" placeholder="ex:0666666666" autofocus required pattern="(\d){10}" title="ex:0666666666" name="tel" id="tel"/></p>
							
							<p><label> Mail* : </label>		<input type="text" name="mail" id="mail"/></p>
				...
				<fieldset>
					...
					<div class="masquable ferme">
						...
						<div class="masquable-contenu">
							...
							<p><label> Co-financement : </label> <input type="text" name="Cofinancement" id="Cofinancement"/></p>
				...
				<fieldset>
					...
					<div class="masquable ferme">
						...
						<div class="masquable-contenu">
							...
							<p><label> - un virement au laboratoire ? : </label> <input type="radio" class="radio" name="virement_au_laboratoire" value="oui"/> Oui <input type="radio" class="radio" name="virement_au_laboratoire" value="non"/> Non </p>
							
							<p><label> - une gestion financière au BRED ? : </label> <input type="radio" class="radio" name="gestion_financiere_bred" value="oui"/> Oui <input type="radio" class="radio" name="gestion_financiere_bred" value="non"/> Non </p>
